  ...
  return (
    <section className="relative h-screen w-full animate-fade-in">
      ...
      <div className="absolute bottom-20 left-6 right-6 md:left-12 md:right-12 max-w-2xl">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-display tracking-wider mb-4 uppercase animate-fade-in" style={{ animationDelay: '0.2s', animationFillMode: 'both' }}>
          Новая
          <br />
          философия
          <br />
