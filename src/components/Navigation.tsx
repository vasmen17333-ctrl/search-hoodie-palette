    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border">
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          <a href="/" className="text-xl tracking-[0.2em] font-display uppercase">
            search
          </a>
          
          <div className="hidden md:flex items-center gap-8 text-sm">
            <a href="#catalog" className="hover:text-muted-foreground transition-colors font-display tracking-[0.15em] uppercase">
              Каталог
            </a>
            <a href="#cards" className="hover:text-muted-foreground transition-colors font-display tracking-[0.15em] uppercase">
              Подарочные карты
            </a>
            <a href="#lookbook" className="hover:text-muted-foreground transition-colors font-display tracking-[0.15em] uppercase">
              Lookbook
            </a>
            <a href="https://t.me/yourusername" target="_blank" rel="noopener noreferrer" className="hover:text-muted-foreground transition-colors font-display tracking-[0.15em] uppercase">
              Телеграмм блог
            </a>
          </div>
